...
public class JwtUtil {
    ...
    // (1) 개발자 임의로 지정한 키 : private Stirng secretKey = "2C68318E352971113645CBC72861E1EC23F48D5BAA5F9B405FED9DDDCA893EB4";
    // (2) 라이브러리 이용한 임의(랜덤) 키 :
        // import java.security.Key;
        // Keys.secretKeyFor( SignatyreAlgorithm.알고리즘명 );
    ...
    public String createToken( String memail ){
        ...
        // + 중복 로그인 방지 하고자 웹서버 가 아닌 Redis 에 토큰 정보 저장 ( 분산 처리 , MSA구축 , AI 속도 등등 )
            // (1) Redis에 토큰 저장하기. ..opsForValue(key , value ); , .opsForValue().set( 계정식별정보 , 토큰 )
            ...
            // (3) Redis에 저장된 특정한 key의 값 확인 .opsForValue().get( key );
